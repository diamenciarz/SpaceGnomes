...
public static class GeometryUtils
{
    ...
    public static List<GameObject> GetVisibleAllies(Vector2 from, Team myTeam, List<EntityTypeProperty.EntityType> entityTypes, float maxDistance = float.MaxValue, SensorType sensorType = SensorType.Camera, GameObject ignoreObject = null)
    {
    ...
    public static List<GameObject> GetVisibleEnemies(Vector2 from, Team myTeam, List<EntityTypeProperty.EntityType> entityTypes, float maxDistance = float.MaxValue, SensorType sensorType = SensorType.Camera, GameObject ignoreObject = null)
    {
    ...
    public static List<GameObject> GetVisibleObjects(Vector2 from, Team myTeam, List<EntityTypeProperty.EntityType> entityTypes, float maxDistance=float.MaxValue, SensorType sensorType = SensorType.Camera, GameObject ignoreObject = null)
    {
    ...
    public static RaycastHit2D? GetFirstVisibleEntity(Vector2 to, Vector2 from, EntityTeam.Team myTeam, EntityTypeProperty.EntityType[] entityTypes, float maxDistance = float.MaxValue, SensorType sensorType = SensorType.Camera)
    {
        RaycastHit2D[] hits = RaycastInLine(to, from, maxDistance, sensorType);
        if (hits.Length == 0) return null;
        ...
        {
            if (closestHit.HasValue && hit.distance >= closestHit.Value.distance) continue;
            EntityTypeProperty entityTypeComponent = hit.collider.GetComponent<EntityTypeProperty>();
