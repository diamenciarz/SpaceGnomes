...
/// <summary>
/// This script will control the position and zoom level of a camera it is attached to.
/// It will make the camera follow the middle point of all observed objects (see StaticCameraController) and will also make sure 
/// that the camera does not fly outside the background sprite if limitView is set to true.
/// </summary>
public class CameraPositionController : MonoBehaviour
{
    ...
    {
        UpdateLimits();
        follow = CameraFocusManager.Instance.observedObjects;
    }
    private void UpdateLimits()
    {
        ...
        Vector2 cameraSize = CameraInformation.Instance.GetCameraSize();
