...
public class ParallaxScroller : MonoBehaviour
{
    ...
    {
        horizontalBoundary = CameraInformation.Instance.GetCameraSize().x * CAMERA_DISTANCE_FACTOR;
        verticalBoundary = CameraInformation.Instance.GetCameraSize().y * CAMERA_DISTANCE_FACTOR;
    }
    #endregion
